//TODO: this.task1Completed (and 2 and 3) is not saved yet
...
farming.SceneTask.prototype.task1 = function(){
    ...
    var checkbox_1 = new farming.Sprite('images/checkbox_'+this.task1Completed+'.png').setSize(20, 20).setPosition(-50,-22).setOpacity(0.8);
    var checkbox_2 = new farming.Sprite('images/checkbox_'+this.task2Completed+'.png').setSize(20, 20).setPosition(-50, 18).setOpacity(0.8);
    var checkbox_3 = new farming.Sprite('images/checkbox_'+this.task3Completed+'.png').setSize(20, 20).setPosition(-50, 58).setOpacity(0.8);
